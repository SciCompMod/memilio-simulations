...
int main(int argc, char** argv)
{
    ...
    std::string out_path = "/localdata1/code_2025/memilio/compare_results/cpp_benchmark_rk4.csv";
    ...
    for (auto n_regions : region_grid) {
        ...
        std::cout << "Regions=" << n_regions << " steps=" << steps << " median_sim=" << sim_median
                  << "s median_total_no_io=" << tot_median << "s (dt=" << dt << ", tmax=" << tmax
                  << ", runs=" << runs << ")\n";
    }
    std::cout << "Benchmark CSV written to: " << out_path << "\n";
    return 0;
}
