...
def plot_icu_on_spain(simulations):
    ...
    population = pd.read_json(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'build/_deps/memilio-src/data/Spain/pydata/provincias_current_population.json'))
...
def load_divi_data():
    divi_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'build/_deps/memilio-src/data/Spain/pydata')
