...
https://github.com/pytorch/opacus/blob/main/opacus/accountants/rdp.py
"""
...
def compute_epsilon(sigma, sampling_prob, global_iterations, delta, verbose=False):
    total_rdp = np.atleast_1d(compute_rdp(
        sampling_prob, sigma, global_iterations, DEFAULT_ALPHAS))
...
def get_noise_multiplier(
        ...
        sample_rate: float,
        steps: int,
        epsilon_tolerance: float = 0.01, max_sigma: float = 1e6) -> float:
    r"""
